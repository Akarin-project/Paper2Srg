...
public class EntityVex extends EntityMob {
    ...
    private boolean func_190656_b(int i) {
        byte b0 = this.field_70180_af.func_187225_a(EntityVex.field_190664_a).byteValue();
        ...
        public void func_75246_d() {
            ...
            for (int i = 0; i < 3; ++i) {
                ...
                if (EntityVex.this.field_70170_p.func_175623_d(blockposition1)) {
                    EntityVex.this.field_70765_h.func_75642_a(blockposition1.func_177958_n() + 0.5D, blockposition1.func_177956_o() + 0.5D, blockposition1.func_177952_p() + 0.5D, 0.25D);
                    if (EntityVex.this.func_70638_az() == null) {
                        EntityVex.this.func_70671_ap().func_75650_a(blockposition1.func_177958_n() + 0.5D, blockposition1.func_177956_o() + 0.5D, blockposition1.func_177952_p() + 0.5D, 180.0F, 20.0F);
                    }
                    break;
                }
            }
    ...
    class a extends EntityAIBase {
        ...
        public void func_75246_d() {
            ...
            if (EntityVex.this.func_174813_aQ().func_72326_a(entityliving.func_174813_aQ())) {
                ...
                double d0 = EntityVex.this.func_70068_e(entityliving);
