...
public class EntityAIMoveIndoors extends EntityAIBase {
    ...
    public boolean func_75250_a() {
        BlockPos blockposition = new BlockPos(this.field_75424_a);

        if ((!this.field_75424_a.field_70170_p.func_72935_r() || this.field_75424_a.field_70170_p.func_72896_J() && !this.field_75424_a.field_70170_p.func_180494_b(blockposition).func_76738_d()) && this.field_75424_a.field_70170_p.field_73011_w.func_191066_m()) {
            if (this.field_75424_a.func_70681_au().nextInt(50) != 0) {
                ...
                Village village = this.field_75424_a.field_70170_p.func_175714_ae().func_176056_a(blockposition, 14);

                if (village == null) {
                    return false;
                } else {
                    this.field_75422_b = village.func_179863_c(blockposition);
    ...
    public void func_75249_e() {
        ...
        BlockPos blockposition = this.field_75422_b.func_179856_e();
        int i = blockposition.func_177958_n();
        int j = blockposition.func_177956_o();
        int k = blockposition.func_177952_p();

        if (this.field_75424_a.func_174818_b(blockposition) > 256.0D) {
