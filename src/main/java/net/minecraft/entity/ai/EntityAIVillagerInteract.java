...
public class EntityAIVillagerInteract extends EntityAIWatchClosest2 {
    ...
    public EntityAIVillagerInteract(EntityVillager entityvillager) {
        ...
        this.field_179477_f = entityvillager;
    }
    ...
    public void func_75246_d() {
        ...
        if (this.field_179478_e > 0) {
            --this.field_179478_e;
            if (this.field_179478_e == 0) {
                InventoryBasic inventorysubcontainer = this.field_179477_f.func_175551_co();
                ...
                for (int i = 0; i < inventorysubcontainer.func_70302_i_(); ++i) {
                    ...
                    if (!itemstack.func_190926_b()) {
                        ...
                        if ((item == Items.field_151025_P || item == Items.field_151174_bG || item == Items.field_151172_bF || item == Items.field_185164_cV) && itemstack.func_190916_E() > 3) {
                            ...
                            itemstack1 = new ItemStack(item, j, itemstack.func_77960_j());
