...
public class EntityAIFollowParent extends EntityAIBase {
    ...
    public boolean func_75250_a() {
        if (this.field_75348_a.func_70874_b() >= 0) {
            ...
            List list = this.field_75348_a.field_70170_p.func_72872_a(this.field_75348_a.getClass(), this.field_75348_a.func_174813_aQ().func_72314_b(8.0D, 4.0D, 8.0D));
    ...
    public void func_75246_d() {
        if (--this.field_75345_d <= 0) {
            ...
            this.field_75348_a.func_70661_as().func_75497_a((Entity) this.field_75346_b, this.field_75347_c);
        }
    }
}
