...
public class EntityEnderEye extends Entity {
    ...
    public double targetX; // CraftBukkit private -> public // PAIL rename targetX
    public double targetY; // CraftBukkit private -> public // PAIL rename targetY
    public double targetZ; // CraftBukkit private -> public // PAIL rename targetZ
    public int despawnTimer; // CraftBukkit private -> public // PAIL rename despawnTimer
    public boolean shatterOrDrop; // CraftBukkit private -> public // PAIL rename shouldDropItem
    ...
    public void moveTowards(BlockPos blockposition) {
