...
public class EntityEnderEye extends Entity {
    ...
    public double field_70224_b; // CraftBukkit private -> public // PAIL rename targetX
    public double field_70225_c; // CraftBukkit private -> public // PAIL rename targetY
    public double field_70222_d; // CraftBukkit private -> public // PAIL rename targetZ
    public int field_70223_e; // CraftBukkit private -> public // PAIL rename despawnTimer
    public boolean field_70221_f; // CraftBukkit private -> public // PAIL rename shouldDropItem
    ...
    public void func_180465_a(BlockPos blockposition) {
        double d0 = (double) blockposition.func_177958_n();
        int i = blockposition.func_177956_o();
        double d1 = (double) blockposition.func_177952_p();
