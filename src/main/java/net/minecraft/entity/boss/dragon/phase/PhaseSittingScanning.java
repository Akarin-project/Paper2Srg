...
public class PhaseSittingScanning extends PhaseSittingBase {
    ...
    public void func_188659_c() {
        ++this.field_188667_b;
        EntityPlayer entityhuman = this.field_188661_a.field_70170_p.func_184142_a((Entity) this.field_188661_a, 20.0D, 10.0D);

        if (entityhuman != null) {
            if (this.field_188667_b > 25) {
                this.field_188661_a.func_184670_cT().func_188758_a(PhaseList.field_188748_h);
            } else {
                Vec3d vec3d = (new Vec3d(entityhuman.field_70165_t - this.field_188661_a.field_70165_t, 0.0D, entityhuman.field_70161_v - this.field_188661_a.field_70161_v)).func_72432_b();
                ...
                if (f1 < 0.0F || f1 > 10.0F) {
                    double d0 = entityhuman.field_70165_t - this.field_188661_a.field_70986_h.field_70165_t;
                    double d1 = entityhuman.field_70161_v - this.field_188661_a.field_70986_h.field_70161_v;
            ...
            entityhuman = this.field_188661_a.field_70170_p.func_184142_a((Entity) this.field_188661_a, 150.0D, 150.0D);
            ...
            if (entityhuman != null) {
                ...
                ((PhaseChargingPlayer) this.field_188661_a.func_184670_cT().func_188757_b(PhaseList.field_188749_i)).func_188668_a(new Vec3d(entityhuman.field_70165_t, entityhuman.field_70163_u, entityhuman.field_70161_v));
            }
        }
