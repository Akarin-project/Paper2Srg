...
public class PhaseStrafePlayer extends PhaseBase {
    ...
    public void func_188659_c() {
        if (this.field_188693_f == null) {
            PhaseStrafePlayer.field_188689_b.warn("Skipping player strafe phase because no player was found");
            ...
            if (this.field_188691_d != null && this.field_188691_d.func_75879_b()) {
                d0 = this.field_188693_f.field_70165_t;
                d1 = this.field_188693_f.field_70161_v;
                double d3 = d0 - this.field_188661_a.field_70165_t;
                double d4 = d1 - this.field_188661_a.field_70161_v;

                d2 = (double) MathHelper.func_76133_a(d3 * d3 + d4 * d4);
            ...
            d0 = this.field_188692_e == null ? 0.0D : this.field_188692_e.func_186679_c(this.field_188661_a.field_70165_t, this.field_188661_a.field_70163_u, this.field_188661_a.field_70161_v);
            ...
            if (this.field_188693_f.func_70068_e(this.field_188661_a) < 4096.0D) {
                if (this.field_188661_a.func_70685_l(this.field_188693_f)) {
                    ++this.field_188690_c;
                    Vec3d vec3d = (new Vec3d(this.field_188693_f.field_70165_t - this.field_188661_a.field_70165_t, 0.0D, this.field_188693_f.field_70161_v - this.field_188661_a.field_70161_v)).func_72432_b();
                    ...
                    f1 += 0.5F;
                    if (this.field_188690_c >= 5 && f1 >= 0.0F && f1 < 10.0F) {
                        d2 = 1.0D;
    ...
    private void func_188688_k() {
        if (this.field_188691_d != null && !this.field_188691_d.func_75879_b()) {
            ...
            this.field_188692_e = new Vec3d(d0, d2, d1);
        }
    ...
    public void func_188686_a(EntityLivingBase entityliving) {
        this.field_188693_f = entityliving;
        int i = this.field_188661_a.func_184671_o();
