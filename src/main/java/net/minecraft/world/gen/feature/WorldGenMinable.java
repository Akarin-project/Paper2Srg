...
public class WorldGenMinable extends WorldGenerator {
    ...
    public boolean func_180709_b(World world, Random random, BlockPos blockposition) {
        ...
        double d0 = blockposition.func_177958_n() + 8 + MathHelper.func_76126_a(f) * this.field_76541_b / 8.0F;
        double d1 = blockposition.func_177958_n() + 8 - MathHelper.func_76126_a(f) * this.field_76541_b / 8.0F;
        double d2 = blockposition.func_177952_p() + 8 + MathHelper.func_76134_b(f) * this.field_76541_b / 8.0F;
        double d3 = blockposition.func_177952_p() + 8 - MathHelper.func_76134_b(f) * this.field_76541_b / 8.0F;
        double d4 = blockposition.func_177956_o() + random.nextInt(3) - 2;
        double d5 = blockposition.func_177956_o() + random.nextInt(3) - 2;
        ...
        for (int i = 0; i < this.field_76541_b; ++i) {
            ...
            double d9 = random.nextDouble() * this.field_76541_b / 16.0D;
            double d10 = (MathHelper.func_76126_a(3.1415927F * f1) + 1.0F) * d9 + 1.0D;
            double d11 = (MathHelper.func_76126_a(3.1415927F * f1) + 1.0F) * d9 + 1.0D;
    ...
    static class a implements Predicate<IBlockState> {
        ...
        @Override
        public boolean apply(IBlockState iblockdata) {
            if (iblockdata != null && iblockdata.func_177230_c() == Blocks.field_150348_b) {
                BlockStone.EnumType blockstone_enumstonevariant = iblockdata.func_177229_b(BlockStone.field_176247_a);
