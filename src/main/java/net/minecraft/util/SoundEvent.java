...
public class SoundEvent {
    ...
    private static void registerSound(String s) {
        ResourceLocation minecraftkey = new ResourceLocation(s);

        SoundEvent.REGISTRY.register(SoundEvent.soundEventId++, minecraftkey, new SoundEvent(minecraftkey));
    }
}
