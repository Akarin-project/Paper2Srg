...
public class ItemIntIDToString implements IFixableData {
    ...
    public NBTTagCompound fixTagCompound(NBTTagCompound nbttagcompound) {
        if (nbttagcompound.hasKey("id", 99)) {
            short short0 = nbttagcompound.getShort("id");

            if (short0 > 0 && short0 < ItemIntIDToString.ID_MAP.length && ItemIntIDToString.ID_MAP[short0] != null) {
                nbttagcompound.setString("id", ItemIntIDToString.ID_MAP[short0]);
            }
        }
    ...
    static {
        ...
        ItemIntIDToString.ID_MAP[350] = "minecraft:cooked_fish"; // Paper - cooked_fished -> cooked_fish
