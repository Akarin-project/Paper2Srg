...
public abstract class Biomes {
    ...
    private static Biome func_185428_a(String s) {
        Biome biomebase = (Biome) Biome.field_185377_q.func_82594_a(new ResourceLocation(s));
    ...
    static {
        if (!Bootstrap.func_179869_a()) {
            ...
            field_180279_ad = Biomes.field_76771_b;
