    ...
    public void execute(MinecraftServer minecraftserver, ICommandSender icommandlistener, String[] astring) throws CommandException {
        if (astring.length < 2) {
            ...
            if (entity instanceof EntityPlayer) {
                ...
                try {
                    nbttagcompound2 = JsonToNBT.getTagFromJson(buildString(astring, 1));
                ...
                if (nbttagcompound.equals(nbttagcompound1)) {
                    ...
                    notifyCommandListener(icommandlistener, (ICommand) this, "commands.entitydata.success", new Object[] { nbttagcompound.toString()});
                }
            }
        }
    }
