...
public class ItemLingeringPotion extends ItemPotion {
    ...
    public String func_77653_i(ItemStack itemstack) {
        return I18n.func_74838_a(PotionUtils.func_185191_c(itemstack).func_185174_b("lingering_potion.effect."));
    }
    ...
    public ActionResult<ItemStack> func_77659_a(World world, EntityPlayer entityhuman, EnumHand enumhand) {
        ...
        world.func_184148_a((EntityPlayer) null, entityhuman.field_70165_t, entityhuman.field_70163_u, entityhuman.field_70161_v, SoundEvents.field_187756_df, SoundCategory.NEUTRAL, 0.5F, 0.4F / (ItemLingeringPotion.field_77697_d.nextFloat() * 0.4F + 0.8F));
