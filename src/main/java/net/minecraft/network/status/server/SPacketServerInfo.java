...
public class SPacketServerInfo implements Packet<INetHandlerStatusClient> {
    ...
    public void readPacketData(PacketBuffer packetdataserializer) throws IOException {
        this.response = (ServerStatusResponse) JsonUtils.gsonDeserialize(SPacketServerInfo.GSON, packetdataserializer.readString(32767), ServerStatusResponse.class);
    }

    public void writePacketData(PacketBuffer packetdataserializer) throws IOException {
        packetdataserializer.writeString(SPacketServerInfo.GSON.toJson(this.response));
    }

    public void processPacket(INetHandlerStatusClient packetstatusoutlistener) {
        packetstatusoutlistener.handleServerInfo(this);
    }
}
