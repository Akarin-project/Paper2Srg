...
public class BlockWorldState {
    ...
    public BlockWorldState(World world, BlockPos blockposition, boolean flag) {
        this.field_177515_a = world;
        this.field_177513_b = blockposition;
        this.field_181628_c = flag;
    }
    ...
    public static Predicate<BlockWorldState> func_177510_a(final Predicate<IBlockState> predicate) {
        return new Predicate() {
            public boolean a(@Nullable BlockWorldState shapedetectorblock) {
                return shapedetectorblock != null && predicate.apply(shapedetectorblock.func_177509_a());
            }
